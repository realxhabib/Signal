...
|---|---|---|---|---|---|---|
| Pattern library: 24-bar shapes, 32 patterns, basket rebalanced every 18 bars | +8% | 44% | 0.41 | -0.05 | 2.03 → **2.08** | 0.43 |

Locked year (365 days): sleeve 53.8%, Sharpe 1.50, max DD 16% · account alone Sharpe 1.03 → with 10% sleeve 1.12
