...
|---|---|---|---|---|---|---|
| Pattern library: 24-bar shapes, 32 patterns, 18-bar target traded daily, fee 0.02% | +13% | 23% | 0.86 | 0.08 | 2.03 → **2.08** | 0.32 |

Locked year (365 days): sleeve 49.1%, Sharpe 2.22, max DD 11% · account alone Sharpe 1.03 → with 10% sleeve 1.12
